  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('FeisCool', style: TextStyle(color: Color.fromARGB(255, 0, 0, 0)),),
      ),
      body: Column(
        children: [
            ...
            children: [
              ...
              style: OutlinedButton.styleFrom(
                side: const BorderSide(
                  width: 5.0, color: Color.fromARGB(255, 255, 253, 253)
                )
              ),
      ...
      backgroundColor: Color.fromARGB(255, 255, 255, 255), //color de fondo de la app
    );
  }
}